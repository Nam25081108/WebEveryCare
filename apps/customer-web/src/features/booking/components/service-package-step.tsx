...
import { formatCurrency, professionalInfo, Service, ServicePlan, WorkDetails } from "@/features/booking/lib/mock-data";
import { calculateProfessionalPlan, ProfessionalConfig } from "@/features/booking/lib/professional-pricing";
