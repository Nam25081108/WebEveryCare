export type UtilityService={slug:string;name:string;description:string;icon:string;available?:boolean;bookingService?:"room"|"deep"|"professional"|"office"|"hospitality"};
...
export const serviceCategories:ServiceCategory[]=[
 ...
 {id:"business",name:"Dịch vụ cho doanh nghiệp",shortName:"Doanh nghiệp",eyebrow:"Vận hành chỉn chu",description:"Giải pháp nhân sự vệ sinh linh hoạt cho văn phòng và cơ sở lưu trú.",accent:"#3564c8",soft:"#eaf0ff",services:[
  {slug:"don-dep-van-phong-dinh-ky",name:"Dọn dẹp văn phòng định kỳ",description:"Nhân sự theo ca, theo ngày hoặc lịch cố định.",icon:"briefcase",available:true,bookingService:"office"},
  {slug:"don-dep-buong-phong",name:"Dọn dẹp buồng phòng",description:"Cho căn hộ cho thuê, homestay và khách sạn.",icon:"bed",available:true,bookingService:"hospitality"},
