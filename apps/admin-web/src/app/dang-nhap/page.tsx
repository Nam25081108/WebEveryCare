...
import { useAdminAuth } from "@/features/auth/admin-auth-provider";
...
export default function AdminLoginPage() {
  ...
  useEffect(() => { if (!isLoading && admin) router.replace("/"); }, [admin, isLoading, router]);
