...
export default async function ServiceDetailPage({ params }: { params: Promise<{ slug: string }> }) {
  ...
  return <main className="ec-service-page">
    ...
    <section className="ec-service-detail"><div className="shell"><article className="ec-service-detail-card">
      ...
      <div className="ec-detail-actions"><Link href="/#dich-vu"><ArrowLeft size={16}/> Xem dịch vụ khác</Link><Link href="/doi-tac"><BellRing size={16}/> Đăng ký làm đối tác</Link></div>
    </article></div></section>
    <Footer />
  </main>;
}
